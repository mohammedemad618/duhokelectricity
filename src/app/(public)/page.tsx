...
export default async function HomePage() {
  ...
  return (
    <>
      {/* Hero */}
      <section className="relative overflow-hidden border-b-2 border-accent-500/70 bg-gradient-to-bl from-brand-800 via-brand-900 to-brand-950 text-white">
        <Container className="relative grid items-center gap-10 py-14 lg:grid-cols-2 lg:py-20">
          <div>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <Link
                href="/news"
                className="rounded-lg bg-accent-500 px-6 py-3 font-bold text-brand-950 shadow-sm transition hover:bg-accent-400"
              >
                {dict.home.browseNews}
              </Link>
              <Link
                href="/complaints"
                className="rounded-lg bg-white/10 px-6 py-3 font-bold text-white ring-1 ring-white/30 transition hover:bg-white/20"
              >
          ...
          <div className="lg:justify-self-end">
            <div className="rounded-lg bg-white/10 p-6 ring-1 ring-white/20 backdrop-blur">
              <div className="flex items-center gap-4 rounded-lg bg-accent-500 p-4 text-brand-950">
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
          {quickLinks.map(({ label, desc, href, Icon }) => (
            <Link
              key={href}
              href={href}
              className="group flex items-center gap-3 rounded-lg border border-slate-200 bg-white p-4 transition hover:border-brand-300 hover:shadow-sm"
            >
              <span className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-brand-50 text-brand-600 transition group-hover:bg-brand-600 group-hover:text-white">
      ...
      <section className="py-14">
        <Container>
          <div className="overflow-hidden rounded-xl border-t-2 border-accent-500/70 bg-gradient-to-l from-brand-700 to-brand-900 px-6 py-10 text-center text-white sm:px-12">
            ...
            <Link
              href="/complaints"
              className="mt-6 inline-block rounded-lg bg-accent-500 px-8 py-3 font-bold text-brand-950 shadow-sm transition hover:bg-accent-400"
            >
              {dict.home.cta.button}
            </Link>
          </div>
